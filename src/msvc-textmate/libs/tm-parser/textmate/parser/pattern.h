...
extern std::string PatternErrors;
...
private:
    ...
    friend match_t search(pattern_t const& ptrn, char const* first,
        char const* last, char const* from, char const* to, char const* gpos,
...
private:
    ...
    friend match_t search(pattern_t const& ptrn, char const* first,
        ...
        char const* gpos, OnigOptionType options);
...
match_t search(pattern_t const& ptrn, char const* first, char const* last,
    ...
    const char* gpos = NULL, OnigOptionType options = ONIG_OPTION_NONE);
