...
struct scope_t {
    ...
    __declspec(dllexport) scope_t();
    __declspec(dllexport) scope_t(char const* scope);
    __declspec(dllexport) scope_t(std::string const& scope);
    __declspec(dllexport) ~scope_t();

    __declspec(dllexport) scope_t(scope_t&& rhs);
    __declspec(dllexport) scope_t(scope_t const& rhs);
    ...
    void pop_scope();
    __declspec(dllexport) std::string const& back() const;
    __declspec(dllexport) size_t size() const;
    bool empty() const;
    size_t hash() const;
...
private:
    ...
    __declspec(dllexport) explicit scope_t(node_t* node);
...
__declspec(dllexport) std::string to_s(scope_t const& s);
